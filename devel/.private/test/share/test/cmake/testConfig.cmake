...
if("TRUE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/csa/ws/test/src/test)
  set(test_DEVEL_PREFIX /home/csa/ws/test/devel/.private/test)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /home/csa/ws/test/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'csa <csa@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/csa/ws/test/src/test/${idir}'.  Ask the maintainer 'csa <csa@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/csa/ws/test/devel/.private/test/lib;/home/csa/ws/test/devel/lib;/opt/ros/kinetic/lib)
